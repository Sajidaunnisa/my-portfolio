    ...
    <div className="container" id="home">
      <div className="tag-line">
        ...
        <a
          href="#projects"
          type="button"
          className="btn btn-sm mt-4 btn-outline-danger"
        >
          My Work
        </a>
        <div className="col-lg-12 d-flex justify-content-center p-4">
          ...
          <a href="www.linkedin.com/in/sajida-unnisa" alt="linkedin">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
              height="16"
          ...
          <a
            href="https://x.com/_Sajidaunnisa?t=XKeiPD9MeVQzOzw8RwJ_zA&s=09"
            alt="twitter-x"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <a
            href="https://www.facebook.com/profile.php?id=100082971940708&mibextid=ZbWKwL"
            alt="facebook"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              ...
              height="16"
              fill="currentColor"
              class="bi bi-facebook text-light me-4"
              viewBox="0 0 16 16"
            >
          ...
          <a
            href="https://www.instagram.com/_sajida.2?igsh=eXZpM29mdmNhOWo2"
            alt="instagram"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
